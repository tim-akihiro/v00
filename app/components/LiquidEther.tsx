 ...
 *
 * Dieser Komponente rendert eine prozedurale Flüssigkeitsanimation mit WebGL und
 * THREE.js. Die Implementierung basiert auf dem vom Nutzer bereitgestellten Code.
 * Die Props erlauben eine feine Anpassung der Simulation. Bei Nichtangabe werden
 * sinnvolle Standardwerte verwendet.
 */
...
/**
 * Implementierung der Flüssigkeitssimulation.
 *
 * Hinweis: Die zugrunde liegende Simulation verwendet mehrere intern definierte
 * Klassen (CommonClass, MouseClass, ShaderPass usw.). Diese sind innerhalb der
 * useEffect-Hooks gekapselt, damit sie nicht während des Server‑Renderings
 * ausgeführt werden. Die `useRef` Referenzen halten die WebGL‑Instanz sowie
 * Beobachter instand, um bei Unmount korrekt aufzuräumen.
 */
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    /** Erzeuge eine Textur aus einem Farbverlauf */
    ...
    /**
     * Interaktionsklasse für Maus- und Touch‑Eingaben
     */
    class MouseClass {
      mouseMoved = false
    ...
    /**
     * Automatischer Treiber für autonome Mausbewegungen.
     */
    class AutoDriver {
      mouse: MouseClass
      manager: any
    ...
    // Shader Strings (vertex/fragment) aus der Vorlage
    const face_vert = `
...
`
  ...
  // Wenn die Props sich ändern, aktualisiere die Simulation
  useEffect(() => {
