...
const features = [
  {
    title: "Gestaltung, die hält",
    description: "Durch das zeitlose Design bleibt ihr Auftritt modern",
    icon: "✨",
  },
  {
    title: "Effektiv",
    description: "Sparen Sie Zeit",
    icon: "📱",
  },
  {
        ...
        <motion.div ref={carousel} className="cursor-grab overflow-hidden">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={index}
                 className="min-w-[300px] h-[400px] p-8 m-4 bg-background rounded-3xl shadow-lg flex flex-col justify-between transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg border-2 border-transparent hover:border-brand-500/10"
              >
                <div>
